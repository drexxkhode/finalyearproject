...
export default function PaymentHistory() {
  ...
  // Use server-computed summary — accurate even when filters are applied server-side later
    ...
    axios.get(`${API}/api/payments/admin`, { headers })
      .then(res => {
        ...
        setSummary({
          ...
          // refund_amount from server is the actual money returned, not the original charge
    ...
    <div className="col-xxl-12">
      ...
      <div className="card shadow-sm mb-3">
        <div className="card-header d-flex flex-wrap align-items-center gap-2">
          ...
          <select className="form-select form-select-sm" style={{width:160}} value={status} onChange={e => setStatus(e.target.value)}>
            ...
            <div className="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
              ...
              <div className="modal-body px-4 py-3">
                <div className="d-flex align-items-center gap-3 mb-3 p-3 rounded" style={{background:"#f8f9fa"}}>
                  ...
                  <div>
                    <div className="fw-bold">{selected.user_name || "Deleted user"}</div>
                ...
                {[
                  ...
                  { label:"Refunded Amt", value:fmtAmt(selected.refund_amount) },

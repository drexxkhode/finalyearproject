...
const ForgotPassword = () => {
  ...
  try {
    ...
    const cooldownMinutes = res.data.minutesLeft || 5; // you can have server return this
    ...
    if (err.response?.status === 429) {
      ...
      const timeLeft = err.response.data.minutesLeft || 15;
              ...
              <div className="border rounded-2 p-4 mt-5">
                <div className="login-form">
                  ...
                  <div className="d-grid py-3 mt-2">
                    <button type="submit" disabled={disabled} className="btn btn-lg btn-primary">
                      Send Reset Link
                    </button>
                  </div>
                    </form>
